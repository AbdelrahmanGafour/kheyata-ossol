...
(function () {
  ...
  /* رسالة Toast تلقائية عند نجاح إضافة منتج للسلة عبر WooCommerce AJAX add-to-cart. */
  if (window.jQuery) {
    jQuery(document.body).on('added_to_cart', function () {
      window.showToast('تمت إضافة المنتج إلى السلة', 'fa-solid fa-cart-circle-check');
    });
  }

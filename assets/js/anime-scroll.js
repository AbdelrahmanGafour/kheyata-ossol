...
(function () {
  ...
  function initHeroScrollEffect() {
    ...
    /* تأثير مصاحب للتمرير: الخلفية تتحرك للأعلى وتتكبّر قليلًا وتتلاشى
       طبقة المحتوى بسرعة أكبر لتكشف القسم التالي بحركة سلسة */
    ...
    /* الأقسام التالية تنزلق للأعلى بحركة حرة (غير مرتبطة بالتمرير) عند دخولها الشاشة */
    ...
    /* مؤشر التمرير المتحرك أسفل الهيرو */
  ...
  /* اهتزاز خفيف لأيقونات الخدمات عند المرور فوقها */
